...
const messages = {
  de: {
    ...
    'game.over.support': '{treat} spendieren',
    'game.over.restart': 'Neu starten',
    'support.title': 'Macht dir das Spiel Spaß?',
    'support.text.beer':
      'Welche Partei? ist kostenlos. Ein kleines Bier hilft, das Projekt am Leben zu halten.',
    'support.text.pretzel':
      'Welche Partei? ist kostenlos. Eine kleine Brezel hilft, das Projekt am Leben zu halten.',
    'support.cta': '{treat} spendieren',
    'support.later': 'Vielleicht später',
    'treat.beer': 'Bier',
    'treat.pretzel': 'Brezel',
    ...
    'wp.landing.meta.time': '~5 Minuten',
    ...
    'wp.blind.showPositions': 'Was sagen die Parteien dazu?',
    'wp.blind.hidePositions': 'Parteipositionen ausblenden',
    'wp.blind.positionsHint': 'Tippe auf eine Partei, um Quelle & Begründung zu sehen.',
    ...
    'wp.gegencheck.noDataDecisive': 'Keine dokumentierte Position zu deinem K.O.-Kriterium „{issue}“',
    'wp.gegencheck.lowCoverageBadge': 'Zu wenig Daten',
    'wp.gegencheck.coverage': '{comparable} von {total} vergleichbaren Antworten',
    ...
    'wp.coffee.sub.beer': 'Unterstütze die Weiterentwicklung mit einem Bier.',
    'wp.coffee.sub.pretzel': 'Unterstütze die Weiterentwicklung mit einer Brezel.',
    'wp.coffee.btn': '{treat} spendieren →',
  ...
  en: {
    ...
    'game.over.support': 'Buy a {treat}',
    'game.over.restart': 'Restart',
    'support.title': 'Enjoying the game?',
    'support.text.beer':
      'Welche Partei? is free. A small beer helps keep the project online.',
    'support.text.pretzel':
      'Welche Partei? is free. A small pretzel helps keep the project online.',
    'support.cta': 'Buy a {treat}',
    'support.later': 'Maybe later',
    'treat.beer': 'beer',
    'treat.pretzel': 'pretzel',
    ...
    'wp.landing.meta.time': '~5 minutes',
    ...
    'wp.answer.neutralShort': 'Neutral',
    'wp.blind.showPositions': 'What do the parties say?',
    'wp.blind.hidePositions': 'Hide party positions',
    'wp.blind.positionsHint': 'Tap a party to see the source & reasoning.',
    'wp.gegencheck.eyebrow': 'Results',
    'wp.gegencheck.title': 'Your match',
    'wp.gegencheck.answered': '{answered} of {total} questions answered',
    'wp.gegencheck.noDataDecisive': 'No documented position on your dealbreaker issue, "{issue}"',
    'wp.gegencheck.lowCoverageBadge': 'Not enough data',
    'wp.gegencheck.coverage': '{comparable} of {total} comparable answers',
    ...
    'wp.coffee.sub.beer': 'Support further development with a beer.',
    'wp.coffee.sub.pretzel': 'Support further development with a pretzel.',
    'wp.coffee.btn': 'Buy a {treat} →',
    'wp.stats.eyebrow': 'Community',
